...
var file_filters_v1alpha1_rate_limit_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x22, 0x57, 0x0a, 0x0f, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x44, 0x0a, 0x08, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x69,
	0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x6b, 0x6e, 0x6f, 0x77, 0x61,
	...
	0x63, 0x79, 0x52, 0x08, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x2a, 0x4f, 0x0a, 0x0f,
	0x52, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x42, 0x61, 0x73, 0x65, 0x4f, 0x6e, 0x12,
	0x22, 0x0a, 0x1e, 0x52, 0x41, 0x54, 0x45, 0x5f, 0x4c, 0x49, 0x4d, 0x49, 0x54, 0x5f, 0x42, 0x41,
	0x53, 0x45, 0x5f, 0x4f, 0x4e, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45,
	0x44, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x49, 0x44, 0x10, 0x01,
	0x12, 0x0b, 0x0a, 0x07, 0x41, 0x50, 0x49, 0x5f, 0x4b, 0x45, 0x59, 0x10, 0x02, 0x42, 0x21, 0x5a,
...
var file_filters_v1alpha1_rate_limit_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_filters_v1alpha1_rate_limit_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_filters_v1alpha1_rate_limit_proto_goTypes = []interface{}{
	(RateLimitBaseOn)(0),      // 0: knoway.filters.v1alpha1.RateLimitBaseOn
	(*StringMatch)(nil),       // 1: knoway.filters.v1alpha1.StringMatch
	(*RateLimitPolicy)(nil),   // 2: knoway.filters.v1alpha1.RateLimitPolicy
	(*RateLimitConfig)(nil),   // 3: knoway.filters.v1alpha1.RateLimitConfig
	(*duration.Duration)(nil), // 4: google.protobuf.Duration
}
var file_filters_v1alpha1_rate_limit_proto_depIdxs = []int32{
	1, // 0: knoway.filters.v1alpha1.RateLimitPolicy.match:type_name -> knoway.filters.v1alpha1.StringMatch
	0, // 1: knoway.filters.v1alpha1.RateLimitPolicy.based_on:type_name -> knoway.filters.v1alpha1.RateLimitBaseOn
	4, // 2: knoway.filters.v1alpha1.RateLimitPolicy.duration:type_name -> google.protobuf.Duration
	2, // 3: knoway.filters.v1alpha1.RateLimitConfig.policies:type_name -> knoway.filters.v1alpha1.RateLimitPolicy
